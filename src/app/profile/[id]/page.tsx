        ...
        <div>
          ...
          <div className='w-[100%] flex flex-col items-start justify-start gap-1 mb-5'>
              ...
              <div className='flex items-start justify-center flex-col relative w-[100%]'>
                <Image src={ user?.avatar ?? "https://images.pexels.com/photos/259588/pexels-photo-259588.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"} height={60} width={60} alt='user-image' className='rounded-sm h-[12rem] w-[100%] object-cover'/>
